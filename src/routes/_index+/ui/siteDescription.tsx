...
export function SiteDescription() {
    const step1 = (
        <>
            ...
            <p className="min-w-0 whitespace-nowrap">add writing and images</p>
        </>
    )
    ...
    const step2 = (
        <>
            ...
            <p className="min-w-0 whitespace-nowrap">add interactivity</p>
        </>
    )
    ...
    const step3 = (
        <>
            ...
            <p className="min-w-0 whitespace-nowrap">host and share</p>
        </>
    )

    return (
        <div className="flex min-h-0 items-center gap-3 [&>*>*]:skew-x-3 [&>*]:-skew-x-3">
